      ...
      try {
        ...
        if (fullText) {
          ...
          if (assistantMsgError) {
            console.error('[monster/chat] failed to persist assistant message:', assistantMsgError.message);
          }
        }
        ...
        console.error(`[monster/chat] conversation=${activeConversationId} unhandled error:`, errorMsg);
