...
export function HomepageSeoPanel({ siteId, currentContent, currentScore }: HomepageSeoProps) {
  ...
  const fetchStatus = useCallback(() => getLatestSeoJobStatus(siteId, "seo_homepage"), [siteId]);
  ...
  return (
    <div className="mt-4 rounded-lg border border-border bg-muted/20 p-4 space-y-3">
      ...
      {}
      {currentContent && (currentContent.meta_description || currentContent.intro) && (
